...
const BASE_URL = "https://www.jcmobiledetailings.com";
...
export default function sitemap(): MetadataRoute.Sitemap {
  const staticPages = [
    ...
    { url: `${BASE_URL}/services/ceramic-coating`, lastModified: new Date(), changeFrequency: "monthly" as const, priority: 0.8 },
    { url: `${BASE_URL}/services/clay-seal`, lastModified: new Date(), changeFrequency: "monthly" as const, priority: 0.7 },
    { url: `${BASE_URL}/services/maintenance-detail`, lastModified: new Date(), changeFrequency: "monthly" as const, priority: 0.7 },
    { url: `${BASE_URL}/services/fleet-detailing`, lastModified: new Date(), changeFrequency: "monthly" as const, priority: 0.7 },
  ];
